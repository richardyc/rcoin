rcoin version 0.3.3.1 is now available from:
...
Added support for rcoin URIs in QT wallet.
...
- `722c5dc` Change strings to rcoin (uppercase) and other miscellaneous fixes
- `18993f7` Correct translatable string from Bitcoin to rcoin
- `a0cb315` Remove duplicate spaces from a string
- `648fc59` Add an option to open the rcoin.conf in the default editor
- `80dbe2e` Add a notice when selecting edit config in QT
- `02d42ae` Fix Opening on OSX
- `4898c94` rcoin-Qt (Windows only): extend Resource File
...
- `0142107` Change Window title to "rcoin - Wallet" / misc related renames
...
- `f687b68` Add support for opening rcoin: URIs directly.
...
- `c5c281a` Rename project to rcoin-qt
...
- `ca2ae7a` Rename rpcuser from bitcoinrpc --> rcoinrpc in message dialog
