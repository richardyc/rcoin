...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "rcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are rcoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.rcoin.com", "dnsseed.rcoin.com"},
    {"dnsseed.rcoinfoundation.org", "dnsseed.rcoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.rcoin.com", "tseed.rcoin.com"},
    {"testnet-seed.rcoin.mitchellcash.com", "testnet-seed.rcoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for rcoin, rcoinfoundation, xpydev
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. rcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // rcoin: mint proof-of-stake blocks in the background
